...
// interface RecepieListProps {
//   RecipeArray: RecipeArray;
//   setRecepies: React.Dispatch<React.SetStateAction<never[]>>;
// }
...
// const RecepieList: React.FC<RecepieListProps> = ({ RecipeArray, setRecepies }) => {
...
//       async function DelteRecepie(id:any)
//       {
//         try {
...
//           if(response.status==200)
//           { 
//             let array = RecipeArray.filter((item)=> item._id!=id )
//             setRecepies(array);
//             console.log(array);
//           }
//         } catch (error) {
...
//       </div>
//         <div className="flex justify-between pl-3 pr-3 pb-3 text-blue-500">
//           <button ><Link href={`/app/edit/${item.recepieId}`}>Edit  </Link> </button>
//           <button onClick={(e)=> DelteRecepie(item._id)}>Delete</button>
//         </div>
//     </div>
